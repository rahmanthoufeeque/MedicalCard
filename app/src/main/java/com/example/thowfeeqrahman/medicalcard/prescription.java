...
public class prescription extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    Button bt1;
    ListView lv1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1=(Button)findViewById(R.id.button14);
